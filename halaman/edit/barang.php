                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" disabled value="<?= $jenis_barang['kode'] . generateKodeBarang($data['kode']); ?>">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="harga_label" name="harga_label" autocomplete="off" required value="<?= $data['harga_label']; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="stok" class="form-label">Stok</label>
                            <input type="text" class="form-control" id="stok" name="stok" autocomplete="off" required value="<?= $data['stok']; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="satuan" class="form-label">Satuan</label>
                            <input type="text" class="form-control" id="satuan" name="satuan" autocomplete="off" required value="<?= $data['satuan']; ?>">
                        </div>
                        <hr>
