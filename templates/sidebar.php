<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item <?= in_array(($_GET['h'] ?? ''), ['toko', 'penjualan_toko', 'distribusi_barang', 'detail_distribusi_barang', 'tambah_penjualan_toko', 'tambah_toko', 'tambah_distribusi_barang', 'edit_penjualan_toko', 'edit_toko', 'edit_distribusi_barang']) ? 'active' : '' ?>">
        <a class="nav-link <?= in_array(($_GET['h'] ?? ''), ['toko', 'penjualan_toko', 'distribusi_barang', 'detail_distribusi_barang', 'tambah_penjualan_toko', 'tambah_toko', 'tambah_distribusi_barang', 'edit_penjualan_toko', 'edit_toko', 'edit_distribusi_barang']) ? '' : 'collapsed' ?>" href="#" data-toggle="collapse" data-target="#toko" aria-expanded="true" aria-controls="toko">
            <i class="fas fa-truck"></i>
            <span>Toko</span>
        </a>
        <div id="toko" class="collapse <?= in_array(($_GET['h'] ?? ''), ['toko', 'penjualan_toko', 'distribusi_barang', 'detail_distribusi_barang', 'tambah_penjualan_toko', 'tambah_toko', 'tambah_distribusi_barang', 'edit_penjualan_toko', 'edit_toko', 'edit_distribusi_barang']) ? 'show' : '' ?>" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <?php if ($_SESSION['user']['status'] == 'ADMIN') : ?>
