<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion <?= $_SESSION['user']['status'] === 'PEGAWAI' ? 'toggled' : ''; ?>" id="accordionSidebar">
    ...
    <?php if ($_SESSION['user']['status'] == 'ADMIN' || $_SESSION['user']['status'] == 'PETUGAS') : ?>
        ...
        <li class="nav-item <?= in_array(($_GET['h'] ?? ''), ['laporan_barang', 'laporan_penjualan_toko', 'laporan_distribusi_barang', 'laporan_penyuplaian', 'laporan_return_barang', 'laporan_pameran', 'laporan_penjualan_pameran', 'laporan_keuangan']) ? 'active' : '' ?>">
            <a class="nav-link <?= in_array(($_GET['h'] ?? ''), ['laporan_barang', 'laporan_penjualan_toko', 'laporan_distribusi_barang', 'laporan_penyuplaian', 'laporan_return_barang', 'laporan_pameran', 'laporan_penjualan_pameran', 'laporan_keuangan']) ? '' : 'collapsed' ?>" href="#" data-toggle="collapse" data-target="#laporan" aria-expanded="true" aria-controls="laporan">
                <i class="far fa-file-pdf"></i>
                <span>Laporan</span>
            </a>
            <div id="laporan" class="collapse <?= in_array(($_GET['h'] ?? ''), ['laporan_barang', 'laporan_penjualan_toko', 'laporan_distribusi_barang', 'laporan_penyuplaian', 'laporan_return_barang', 'laporan_pameran', 'laporan_penjualan_pameran', 'laporan_keuangan']) ? 'show' : '' ?>" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
