<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item <?= in_array(($_GET['h'] ?? ''), ['toko', 'distribusi_barang', 'detail_distribusi_barang', 'tambah_toko', 'tambah_distribusi_barang', 'edit_toko', 'edit_distribusi_barang']) ? 'active' : '' ?>">
        ...
        <div id="toko" class="collapse <?= in_array(($_GET['h'] ?? ''), ['toko', 'distribusi_barang', 'detail_distribusi_barang', 'tambah_toko', 'tambah_distribusi_barang', 'edit_toko', 'edit_distribusi_barang']) ? 'show' : '' ?>" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <?php if ($_SESSION['user']['status'] == 'ADMIN') : ?>
